...
class TestIndexView(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username='jamtd', email='jamtdsg1@gmail.com', password='DublinBus1')
    ...
    def test_jouurney_planner(self):
        ...
        request = self.factory.post("/dublinBusHybrid/journeyPlanner/", requestBody)
        request.user = self.user
        
        response = JourneyPlanner.as_view()(request)
        self.assertEqual(response.status_code, 200)
